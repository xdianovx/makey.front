...
<template>
  <main>
      ...
      <div class="container">
        ...
        <div class="top">
          <nav class="top-nav">
            ...
            <NuxtLink class="cat-link" :to="cat.slug" v-for="cat in categories" :key="cat.id">{{ cat.title }}</NuxtLink>
          </nav>

          <div class="top-nav-filters">
            <div class="top-nav-sort">
              <p>сортировка:</p>
    ...
    <section class="category">
      <SectionsCategorySlider :count="12" title="Сумки"/>
      <SectionsCategorySlider :count="4" title="Рюкзаки"/>
      <SectionsCategorySlider :count="6" title="Кошельки"/>
      <SectionsCategorySlider :count="3" title="Ремни"/>
      <SectionsCategorySlider :count="7" title="Косметички"/>
      <SectionsCategorySlider :count="6" title="Аксессуары"/>
      <SectionsCategorySlider :count="4" title="Духи"/>
      <SectionsCategorySlider :count="2" title="Для дома"/>
    </section>
...
.top-nav-sort__selector {
  text-decoration: underline;
}

.div {
  background: rgba($bgBLack, .1);
  width: 1px;
  height: 24px;
}
