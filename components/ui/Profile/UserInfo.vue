    ...
    <div class="container">
      <div class="user-info__wrap">
        ...
        <div class="user-email">
          <NuxtLink to="mailto:vlad.yush@icloud.com"
            >vlad.yush@icloud.com</NuxtLink
          >
        </div>
        <div class="user-phone">
          <NuxtLink to="tel:+375 (44) 538-36-94">+375 (44) 538-36-94</NuxtLink>
        </div>
        <div class="user-birthdate">07 октября 2000</div>
        <div class="edit-profile">
          <NuxtLink to="/profile/edit">Редактировать профиль</NuxtLink>
        </div>
      </div>
    </div>
  </section>
